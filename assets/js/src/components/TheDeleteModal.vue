...
<script>
  ...
  export default {
    ...
    components: {
      ...
      BucketDeleteDataForm: () => import(
        /* webpackChunkName: "BucketDeleteDataForm" */
        './BucketDeleteDataForm'
        ),
      CampaignDeleteDataForm: () => import(
        /* webpackChunkName: "CampaignDeleteDataForm" */
        './CampaignDeleteDataForm'
        ),
