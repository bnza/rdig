...
describe('Pottery new form', () => {
  beforeEach(() => {
    cy.fixture('bucket/28932.json').as('bucket28932')
    cy.fixture('bucket/28932.potteries.json').as('bucket28932potteries')
    ...
    cy.route('data/bucket/28932/pottery**', '@bucket28932potteries')
  })
  beforeEach(() => cy.visit('/'))
  beforeEach(() => {
  ...
  describe('Admin user', () => {
    ...
    it('With parent area', () => {
      cy.visit('/#/data/bucket/28932/pottery/create')
      getBucketCodeInput().should('not.have.class', 'v-input--is-readonly')
      cy.wait(500)
      checkAutoCompleteValues({
        siteName: 'Taşlıgeçit Höyük',
