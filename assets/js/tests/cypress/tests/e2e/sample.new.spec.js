...
describe('Object new form', () => {
  beforeEach(() => {
    ...
    cy.fixture('bucket/28932.samples.json').as('bucket28932samples')
    ...
    cy.route('data/bucket/28932/sample**', '@bucket28932samples')
  })
  beforeEach(() => cy.visit('/'))
  beforeEach(() => {
  ...
  describe('Admin user', () => {
    ...
    it('With parent area', () => {
      cy.visit('/#/data/bucket/28932/sample/create')
      getBucketCodeInput().should('not.have.class', 'v-input--is-readonly')
      cy.wait(500)
      checkAutoCompleteValues({
        siteName: 'Taşlıgeçit Höyük',
